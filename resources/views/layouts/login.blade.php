...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('assets/admin/admin/images/ico/apple-icon-120.png')}}">
...
<script src="{{asset('assets/admin/js/core/app.j')}}s" type="text/javascript"></script>
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
