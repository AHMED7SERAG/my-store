                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">إضافة متجر جديد
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات المتجر  </h4>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="projectinput1">رقم التليفون </label>
                                                                <input type="text" 
                                                                    class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" 
                                                                    class="form-control"
                                                                    placeholder="    مثل - ahmed@gmail.com "
                                                                    name="email">
                                                                    @error("email")
                                                                    <span class="text-danger">هذا الحقل مطلوب </span>
                                                                    @enderror
...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjeFgqY-zApJaQltybep4sbQ0oFgvuADQ&callback=initAutocomplete&language=ar&region=EG"></script>
    @stop